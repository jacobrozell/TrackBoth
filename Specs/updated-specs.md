# 📱 TrackBoth - Smart Habit & Vice Tracker
...
I think Goals for daily quanities should be next. 

Starred motivation should appear in Motivations after you add one. It wasnt present until I added a Daily Motivation on my vice, then it showed up along with the Primary Motivation. 

History view needs more padding around the horizontal hstack All, Boolean, QUANTITY. We may need to redesign this view anyway


Spending money as a vice
EX: Video game spending track on a daily, week;ly, monthly basis (from a vice persepctive; this is not a budget tracker app)


Try Dummy Data needs to have Quantity samples for that chart
Undo dummmy data should be there


Quantity goal type picker redesigned for better readability