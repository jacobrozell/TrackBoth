...
Post-1.0 code kept for reference. **Not compiled** into the lean 1.0 app target.
...
Lean 1.0 ships the core iOS app only. See `specs/ProductSurfaceSpec.md` and `docs/feature-inventory.md`.
